# Source: https://github.com/zephyrproject-rtos/zephyr/blob/main/cmake/modules/extensions.cmake
...
function(print_config_variables)
    # Create a list to keep track of printed variables
    set(printed_vars "")

    # Iterate over all defined CMake variables
    get_cmake_property(all_vars VARIABLES)

    foreach(var ${all_vars})
        # Check if the variable starts with "CONFIG_"
        string(FIND ${var} "CONFIG_" var_prefix_index)
        if(${var_prefix_index} EQUAL 0)
            # Check if the variable has already been printed
            list(FIND printed_vars ${var} var_index)
            if(${var_index} EQUAL -1)
                # If not printed yet, print it and add to the list of printed variables
                message("${var}: ${${var}}")
