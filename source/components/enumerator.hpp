...
private:
    ...
    uint8_t colors[17][4]  = {
        ...
        { 0x60, 0x60, 0x60 }, // Exclusive
        { 0x60, 0x60, 0x60 }, // All
        { 0x60, 0x60, 0x60 }, // Reserved
        { 0xff, 0x73, 0x00 }, // Instance_1
        { 0xff, 0xff, 0x00 }, // Instance_2
        { 0x09, 0xff, 0x00 }, // Instance_3
        { 0x00, 0xd5, 0xff }, // Instance_4
        { 0x44, 0x00, 0xff }, // Instance_5
        { 0xff, 0x00, 0xff }, // Instance_6
        { 0xff, 0x96, 0x40 }, // Instance_7
        { 0xff, 0xff, 0x40 }, // Instance_8
        { 0x47, 0xff, 0x40 }, // Instance_9
        { 0x40, 0xe0, 0xff }, // Instance_10
        { 0x40, 0x73, 0xff }, // Instance_11
        { 0xff, 0x40, 0xff }  // Instance_12   
    };
