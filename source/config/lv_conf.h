...
#define LV_ASSERT_HANDLER 0/0;   /*Halt by default*/
...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(material_symbols_sharp_10)

/*Always set a default font*/
#define LV_FONT_DEFAULT &material_symbols_sharp_10
