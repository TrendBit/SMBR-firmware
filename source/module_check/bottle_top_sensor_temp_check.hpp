...
class Bottle_top_sensor_temp_check : public Limit_check<Bottle_temperature> {
public:
    explicit Bottle_top_sensor_temp_check(Bottle_temperature* bottle)
